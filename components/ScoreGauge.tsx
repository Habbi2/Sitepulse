...
export function ScoreGauge({ value, label = 'Overall' }: ScoreGaugeProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2 hb-scale ambient-ring">
      <div className="relative hb-glow gradient-border rounded-full p-[2px]">
      ...
      <div className="text-xl font-semibold tabular-nums hb-text">{normalized.toFixed(1)}</div>
